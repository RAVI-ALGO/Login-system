          ...
          <form className='py-20' onSubmit={handleSubmit}>
            <div className="textbox flex flex-col items-center gap-6">
              <input value={values.password} onChange={handleChange} name='password'
                onBlur={handleBlur} className={styles.textbox} type="text" placeholder='New Password' />
              <input value={values.confirm_pwd} onChange={handleChange} name='confirm_pwd'
                onBlur={handleBlur} className={styles.textbox} type="text" placeholder='Repeat Password' />
